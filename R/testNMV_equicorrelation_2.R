...
#'
#' @export
testNMV_equicorrelation_2 <- function(y, nivel_significancia = 0.05) {
  n <- nrow(y)
  p <- ncol(y)
  q <- p * (p + 1) / 2
  ...
  theta_est_H0 <- c(mu_est_H0,phi_est_H0)
